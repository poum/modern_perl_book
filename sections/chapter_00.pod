...
I<Modern Perl> est un moyen de décrirer la façon dont les programmeurs en Perl 5 les
...
et d'améliorationN<Perl 6 est une réinvention de la programmation s'appuyant sur
...
Toutes les erreurs résiduelles sont inputables à l'obstination de l'auteurN<ou, plus probablement
